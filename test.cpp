 ...
 void ask1(){
    ...
    if(y==1){
        ...
        if(x2==1){
            ...
            allfunc1();
            cin >> x21;
            if(x21==1){func15findsyr();}
            else if(x21==2){func16findsyr();}
            else if(x21==3){func17findsyr();}
            else if(x21==4){func18findsyr();}
            else {cout << "Can not solve ur number";}
    }
    else if(x2==2){
        int x22;
        allfunc();
        cin >> x22;
        if(x22==1){func11findsy1();}
        else if(x22==2){func12findsy2();}
        else if(x22==4){func13findsy3();}
        else if(x22==5){func14findsy4();}
        else {cout << "Can not solve ur number";}
    }
    else {cout << "Can not solve ur number";}
    }
        ...
        cin >> x3;
        if(x3==1){func9findsx1();}
        else if(x3==2){func10findsx2();}
        else {cout << "Can not solve ur number";}
    }
    else if(y==4){
        cout << "Find Sy max" << "\n";
