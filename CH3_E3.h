...
namespace PhysicsCalculator {
	...
	/// Summary for CH3_E3
	/// </summary>
	public ref class CH3_E3 : public System::Windows::Forms::Form
	{
	public:
		CH3_E3(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(CH3_E3::typeid));
			...
			this->F_textBox->Location = System::Drawing::Point(114, 324);
			this->F_textBox->Name = L"F_textBox";
			this->F_textBox->Size = System::Drawing::Size(178, 48);
			this->F_textBox->TabIndex = 173;
			...
			this->F_label->Font = (gcnew System::Drawing::Font(L"CordiaUPC", 21.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->F_label->Location = System::Drawing::Point(41, 329);
			this->F_label->Name = L"F_label";
			this->F_label->Size = System::Drawing::Size(69, 40);
			this->F_label->TabIndex = 172;
			this->F_label->Text = L"F[c] =";
			...
			this->convert_button->TabIndex = 169;
			this->convert_button->Text = L"CONVERT";
			this->convert_button->UseVisualStyleBackColor = true;
			this->convert_button->Click += gcnew System::EventHandler(this, &CH3_E3::convert_button_Click);
			// 
			// reset_button
			// 
			...
			this->reset_button->TabIndex = 168;
			this->reset_button->Text = L"RESET";
			this->reset_button->UseVisualStyleBackColor = false;
			this->reset_button->Click += gcnew System::EventHandler(this, &CH3_E3::reset_button_Click);
			// 
			// m_comboBox
			// 
			...
			this->m_comboBox->Items->AddRange(gcnew cli::array< System::Object^  >(2) { L"g", L"kg" });
			this->m_comboBox->Location = System::Drawing::Point(293, 382);
			this->m_comboBox->Name = L"m_comboBox";
			this->m_comboBox->Size = System::Drawing::Size(94, 48);
			this->m_comboBox->TabIndex = 167;
			...
			this->ans_combo->TabIndex = 166;
			this->ans_combo->SelectedIndexChanged += gcnew System::EventHandler(this, &CH3_E3::ans_combo_SelectedIndexChanged);
			// 
			// m_textBox
			// 
			...
			this->m_textBox->Font = (gcnew System::Drawing::Font(L"CordiaUPC", 21.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->m_textBox->Location = System::Drawing::Point(114, 382);
			this->m_textBox->Name = L"m_textBox";
			this->m_textBox->Size = System::Drawing::Size(178, 48);
			this->m_textBox->TabIndex = 163;
			...
			this->m_label->Font = (gcnew System::Drawing::Font(L"CordiaUPC", 21.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->m_label->Location = System::Drawing::Point(59, 387);
			this->m_label->Name = L"m_label";
			this->m_label->Size = System::Drawing::Size(51, 40);
			this->m_label->TabIndex = 160;
			...
			this->ans_label2->TabIndex = 159;
			this->ans_label2->Text = L"F[c] =";
			...
			this->cal_button->TabIndex = 154;
			this->cal_button->Text = L"CAL";
			this->cal_button->UseVisualStyleBackColor = false;
			this->cal_button->Click += gcnew System::EventHandler(this, &CH3_E3::cal_button_Click);
			// 
			// comboBox1
			// 
			...
			this->comboBox1->Items->AddRange(gcnew cli::array< System::Object^  >(4) {
				L"F[c] (Centripetal Force)", L"m (Mass)", L"v (Velocity)",
					L"R (Radius)"
			});
			...
			this->comboBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &CH3_E3::comboBox1_SelectedIndexChanged);
			// 
			// Find_label
			// 
			...
			this->v_comboBox->Location = System::Drawing::Point(293, 441);
			this->v_comboBox->Name = L"v_comboBox";
			this->v_comboBox->Size = System::Drawing::Size(94, 48);
			this->v_comboBox->TabIndex = 180;
			...
			this->v_textBox->Font = (gcnew System::Drawing::Font(L"CordiaUPC", 21.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->v_textBox->Location = System::Drawing::Point(114, 441);
			this->v_textBox->Name = L"v_textBox";
			this->v_textBox->Size = System::Drawing::Size(178, 48);
			this->v_textBox->TabIndex = 179;
			...
			this->v_label->Font = (gcnew System::Drawing::Font(L"CordiaUPC", 21.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->v_label->Location = System::Drawing::Point(66, 445);
			this->v_label->Name = L"v_label";
			this->v_label->Size = System::Drawing::Size(45, 40);
			this->v_label->TabIndex = 178;
			...
			this->R_comboBox->Location = System::Drawing::Point(293, 499);
			this->R_comboBox->Name = L"R_comboBox";
			this->R_comboBox->Size = System::Drawing::Size(94, 48);
			this->R_comboBox->TabIndex = 177;
			...
			this->R_textBox->Font = (gcnew System::Drawing::Font(L"CordiaUPC", 21.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->R_textBox->Location = System::Drawing::Point(114, 499);
			this->R_textBox->Name = L"R_textBox";
			this->R_textBox->Size = System::Drawing::Size(178, 48);
			this->R_textBox->TabIndex = 176;
			...
			this->R_label->Font = (gcnew System::Drawing::Font(L"CordiaUPC", 21.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->R_label->Location = System::Drawing::Point(64, 503);
			this->R_label->Name = L"R_label";
			this->R_label->Size = System::Drawing::Size(48, 40);
			this->R_label->TabIndex = 175;
			...
			this->F_u_label->Font = (gcnew System::Drawing::Font(L"CordiaUPC", 21.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->F_u_label->Location = System::Drawing::Point(295, 326);
			this->F_u_label->Name = L"F_u_label";
			this->F_u_label->Size = System::Drawing::Size(31, 40);
			this->F_u_label->TabIndex = 172;
			...
			this->pictureBox1->Location = System::Drawing::Point(163, 77);
...
public:
	double F, m, v, R, ans, pi = 3.14159265358979323846;
	String^ unit;
	...
	void set_window() {
		...
		if (comboBox1->SelectedItem == "F[c] (Centripetal Force)") {
			F_label->Enabled = 0;
			F_textBox->Enabled = 0;
			F_u_label->Enabled = 0;
			...
			m_label->Enabled = 1;
			m_textBox->Enabled = 1;
			m_comboBox->Show();	m_comboBox->SelectedIndex = 1;
	...
	char findwhat() {
		if (System::Convert::ToString(comboBox1->SelectedItem) == "F[c] (Centripetal Force)") return 'F';
		else if (System::Convert::ToString(comboBox1->SelectedItem) == "m (Mass)") return 'm';
	...
	bool checkblank(char find) {
		if (find == 'F') {
			if (m_textBox->Text == "" || v_textBox->Text == "" || R_textBox->Text == "") {
				return 1;
			}
			else return 0;
		}
		else if (find == 'm') {
			if (F_textBox->Text == "" || v_textBox->Text == "" || R_textBox->Text == "") {
				return 1;
			}
			else return 0;
		}
		else if (find == 'v') {
			if (F_textBox->Text == "" || m_textBox->Text == "" || R_textBox->Text == "") {
				return 1;
			}
			else return 0;
		}
		else {
			if (F_textBox->Text == "" || m_textBox->Text == "" || v_textBox->Text == "") {
				return 1;
			}
			else return 0;
		}
